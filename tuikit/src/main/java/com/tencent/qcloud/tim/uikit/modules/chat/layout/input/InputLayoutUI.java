...
public abstract class InputLayoutUI extends LinearLayout implements IInputLayout {
     ...
     * 送礼按钮
     */
    protected ImageView mChatPresent;

    /**
     * 视频按钮
     */
    protected ImageView mChatVideo;
...
//        mShortcutArea = findViewById(R.id.shortcut_area);
        ...
        mChatPresent = findViewById(R.id.chat_present);
        mChatVideo = findViewById(R.id.chat_video);
     ...
     * 礼物点击事件
     */
    public static interface OnPresentClickListener {
        void onPresentClick(View view);
    }

    public InputLayoutUI setOnPresentClickListener(final OnPresentClickListener onPresentClickListener) {

        mChatPresent.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                onPresentClickListener.onPresentClick(mChatPresent);
            }
        });
        return this;
    }
