package com.hzrcht.seaofflowers.http.params;
...
public class PostParams {
    ...
    public RequestBody creatBody() {
        RequestBody body = RequestBody.create(MediaType.parse("application/json; charset=utf-8"), JSONUtils
            .parseMapToJson(params));
        return body;
    }
