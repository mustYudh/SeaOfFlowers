...
@SuppressLint("SetTextI18n") public class MineChatActivity extends BaseBarActivity
    implements MineChatViewer {
  @PresenterLifeCycle private MineChatPresenter mPresenter = new MineChatPresenter(this);
  ...
  @Override protected void loadData() {
    ...
    messageLayout.setOnItemClickListener(new MessageLayout.OnItemClickListener() {
      @Override public void onMessageLongClick(View view, int position, MessageInfo messageInfo) {
        //长按消息    messageInfo消息载体
        mChatLayout.getMessageLayout().showItemPopMenu(position - 1, messageInfo, view);
      }

      @Override public void onUserIconClick(View view, int position, MessageInfo messageInfo) {
  ...
  @Override public void getSysGiftSuccess(SysGiftBean sysGiftBean, ChatLayout mChatLayout) {
    if (sysGiftBean != null) {
  ...
  @Override public void chatStartSuccess() {
    if (inputLayout.mMessageHandler != null) {
  ...
  @Override public void sendGiftSuccess(ChatLayout mChatLayout, SysGiftBean.ResultBean resultBean) {
