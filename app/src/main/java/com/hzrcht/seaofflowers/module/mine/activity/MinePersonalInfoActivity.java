...
public class MinePersonalInfoActivity extends BaseBarActivity
  ...
  @PresenterLifeCycle private MinePersonalInfoPresenter mPresenter =
  ...
  private void initBanner(List<String> xbanner) {
    ...
    if (mBanner != null) {
      ...
      mBanner.setPages(xbanner, new MZHolderCreator() {
        @Override public MZViewHolder createViewHolder() {
  ...
  private void showRechargeDialog(List<SysMoneyBean.RowsBean> rows) {
    ...
    adapter.setOnItemChcekCheckListener(new MineSysMoneyGvAdapter.OnItemChcekCheckListener() {
      @Override public void setOnItemChcekCheckClick(String val, String id) {
        type_id = id;
   ...
   * 关注成功
   */
  @Override public void attentSuccess(int type, AnchorUserInfoBean anchorUserInfoBean) {
    if (type == 0) {
  ...
  @Override public void getUserInfoSuccess(AnchorUserInfoBean anchorUserInfoBean) {
   ...
   * 动态列表
   */
  @Override public void getStateListSuccess(MineDynamicBean mineDynamicBean) {
      ...
      if (mineDynamicBean.rows != null && mineDynamicBean.rows.size() != 0) {
        ...
        adapter.setOnItemDetailsDoCilckListener(
            new MineInfoDynamicRvAdapter.OnItemDetailsDoCilckListener() {
              @Override public void onItemDetailsReportClick(String anchor_id, String state_id) {
   ...
   * 动态点赞
   */
  @Override public void stateLikeSuccess(MineLocationDynamicBean item) {
    if (item.is_like == 0) {
  ...
  @Override public void stateDelSuccess(int position) {
  ...
  @Override public void stateReviewSuccess(MineLocationDynamicBean item) {
  ...
  @Override public void getPhotoAlbumSuccess(PhotoAlbumBean photoAlbumBean) {
  ...
  @Override public void lookPhoneSuccess(AnchorUserInfoBean anchorUserInfoBean) {
  ...
  @Override public void lookPhoneFail(int code, String msg) {
    if (loadDialog.isShowing()) {
      loadDialog.dismiss();
    }
    if (code == 10000) {
  ...
  @Override public void getSysMoneySuccess(SysMoneyBean sysMoneyBean) {
    if (sysMoneyBean != null && sysMoneyBean.rows != null && sysMoneyBean.rows.size() != 0) {
      showRechargeDialog(sysMoneyBean.rows);
    }
  }

  @Override public void orderAddSuccess(PayInfo payInfo) {
    if (rechargeDialog.isShowing()) {
      rechargeDialog.dismiss();
    }
  ...
  @Override public void liveStartSuccess(LiveStartBean liveStartBean) {
  ...
  @Override public void sendGiftSuccess(SysGiftBean.ResultBean resultBean) {
    ToastUtils.show("打赏成功!");
    item = null;
  }

  @Override public void getSysGiftSuccess(SysGiftBean sysGiftBean) {
    if (sysGiftBean != null) {
  ...
  @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP) @Override public void scrollHeight(int h) {
  ...
  @Override public void actionUp(int h) {

  }

  @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP) private void setAlpha(float alpha, int color) {
