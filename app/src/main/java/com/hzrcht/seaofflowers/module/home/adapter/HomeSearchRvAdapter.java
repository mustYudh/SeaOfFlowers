...
public class HomeSearchRvAdapter extends BaseQuickAdapter<String, BaseViewHolder> {
    private Context context;

    public HomeSearchRvAdapter(int layoutResId, @Nullable List<String> data, Context context) {
