...
public class MineSysVipGvAdapter extends BaseAdapter {
    private List<SysMoneyBean.RowsBean> list;
    private Context context;

    public MineSysVipGvAdapter(List<SysMoneyBean.RowsBean> list, Context context) {
        this.list = list;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            view = View.inflate(context, R.layout.item_mine_sys_vip, null);
        ...
        if (list.get(i).isIs_select) {
            ...
            holder.tv_fuhao.setTextColor(context.getResources().getColor(R.color.white));
            ...
            holder.tv_money.setTextColor(context.getResources().getColor(R.color.color_9897E7));
            holder.tv_coin.setTextColor(context.getResources().getColor(R.color.color_9897E7));
            holder.tv_fuhao.setTextColor(context.getResources().getColor(R.color.color_9897E7));
        }
    ...
    public class ViewHolder {
        TextView tv_money, tv_coin, tv_fuhao;
