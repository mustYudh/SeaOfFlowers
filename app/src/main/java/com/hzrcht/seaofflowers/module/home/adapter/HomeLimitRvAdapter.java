...
public class HomeLimitRvAdapter extends BaseQuickAdapter<HomeAnchorListBean.RowsBean, BaseViewHolder> {
    private Context context;

    public HomeLimitRvAdapter(int layoutResId, @Nullable List<HomeAnchorListBean.RowsBean> data, Context context) {
