package com.hzrcht.seaofflowers.thrid;
...
import com.hzrcht.seaofflowers.thrid.oss.PersistenceResponse;
...
public class UploadImage {
    ...
    public static PersistenceResponse uploadImage(Context context, String objectName, final String fileAbsPath) {
        ...
        final String accessKeyId = "LTAIi82oZ0mOOToP";
        final String secretKeyId = "OfOY0H3SC073XOBLaISCuTlDoC0yWy";
